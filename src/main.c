...
int main(int argc, char* argv[]) {
    ...
    Trie *trie_english = construct_trie("dict/english-wordlist.txt");
    Trie *trie_french = construct_trie("dict/french-wordlist.txt");
    Trie *trie_german = construct_trie("dict/german-wordlist.txt");
